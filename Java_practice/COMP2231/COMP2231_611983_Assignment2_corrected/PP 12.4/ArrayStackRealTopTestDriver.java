 ...
 * @Description: ArrayStackRealTopTestDriver tests the ArrayStackRealTop class
 */
import java.util.*;
public class ArrayStackRealTopTestDriver
{
    public static void main(String[] args)
    {
        //create an empty stack
        ArrayStackRealTop<Integer> stack = new ArrayStackRealTop<Integer>();
        ...
        System.out.println("The top element of the stack is: \n" + stack.peek());
        System.out.println();
        //print the stack from top to bottom
        System.out.println("This is the stack now: \n" + stack.toString());
        System.out.println();
