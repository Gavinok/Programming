 ...
 * @Last Modified Time: Feb 12, 2018 4:08 PM
 * @Student Number:T00611983
 * @COMP 2231 Assignment 3 Question 4
 * @Description: QueueUsingArrayList implemments a Queue using a ArrayList.
 */
...
public class QueueUsingArrayList<T> {
	 ...
	 * @param element element to be added onto the end of the Queue
	 */
    ...
    {
        QueueUsingArrayList<Integer> queue = new QueueUsingArrayList<Integer>();
